...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.MyViewHolder> {
    ...
    private List<F1bean.DataBean.BestSellersBean.GoodsListBeanX> list;

    public RecyclerAdapter(Context context,List<F1bean.DataBean.BestSellersBean.GoodsListBeanX> list) {
