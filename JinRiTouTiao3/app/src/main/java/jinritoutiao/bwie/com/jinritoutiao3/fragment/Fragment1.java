...
import jinritoutiao.bwie.com.jinritoutiao3.activity.PinDaoActivity;
...
public class Fragment1 extends Fragment {
    ...
    private void initview(View view) {
        ...
        ImageView tianJiaTable= (ImageView) view.findViewById(R.id.tianJiaTable);
        ...
        tianJiaTable.setOnClickListener(new View.OnClickListener() {
            @Override
